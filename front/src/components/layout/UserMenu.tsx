  ...
  return (
    <>
      <button onClick={onToggle} className="flex items-center gap-2 hover:bg-white/10 rounded-lg px-2.5 py-1.5 transition-colors">
        <div className="w-7 h-7 bg-[#457b9d] rounded-full flex items-center justify-center text-white text-xs font-bold">김</div>
        <span className="text-sm text-white font-medium">김담당자</span>

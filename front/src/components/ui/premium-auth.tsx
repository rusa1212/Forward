...
import { Mail, Lock, User, Eye, EyeOff, Shield, AlertTriangle, KeyRound, Phone, Loader2 } from 'lucide-react'
...
export function AuthForm({ onSuccess, onClose, initialMode = 'login', className }: AuthFormProps) {
  ...
  const validateForm = useCallback(() => {
    ...
    const fieldsToValidate: (keyof FormData & keyof FormErrors)[] = ['email', 'password']
          ...
          <div>
            <div className="relative">
              ...
              {errors.verificationCode && (
                <p id="code-error" className="text-destructive text-xs mt-1 flex items-center gap-1 justify-center">
                  <AlertTriangle className="h-3 w-3" />
                  {errors.verificationCode}
                </p>
              )}
      ...
      <div className="space-y-4 animate-in fade-in-50 slide-in-from-right-5">
        {authMode === 'signup' && (
          <div>
            <div className="relative">
              ...
              />
              {errors.name && (
                <p id="name-error" className="text-destructive text-xs mt-1 flex items-center gap-1">
                  <AlertTriangle className="h-3 w-3" />
                  {errors.name}
                </p>
              )}
        ...
        <div>
          <div className="relative">
            ...
            {errors.password && (
              <p id="password-error" className="text-destructive text-xs mt-1 flex items-center gap-1">
                <AlertTriangle className="h-3 w-3" />
                {errors.password}
              </p>
            )}
          ...
          <div>
            <div className="relative">
              ...
              {errors.confirmPassword && (
                <p id="confirm-password-error" className="text-destructive text-xs mt-1 flex items-center gap-1">
                  <AlertTriangle className="h-3 w-3" />
                  {errors.confirmPassword}
                </p>
              )}
        ...
        {authMode === 'signup' && (
          <div>
            <div className="relative">
              ...
              />
              {errors.phone && (
                <p id="phone-error" className="text-destructive text-xs mt-1 flex items-center gap-1">
                  <AlertTriangle className="h-3 w-3" />
                  {errors.phone}
                </p>
              )}
        ...
        {errors.agreeToTerms && (
          <p id="terms-error" className="text-destructive text-xs flex items-center gap-1">
            <AlertTriangle className="h-3 w-3" />
            {errors.agreeToTerms}
          </p>
        )}
